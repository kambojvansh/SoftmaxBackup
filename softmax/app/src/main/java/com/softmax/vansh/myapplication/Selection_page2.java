...
public class Selection_page2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String value1= getIntent().getStringExtra("SpinnerName");
        SharedPreferences sharedPreferences = Selection_page2.this.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);

        SharedPreferences.Editor editor = sharedPreferences.edit();

        editor.putBoolean(LOGGEDIN_SHARED_PREF, true);
        //editor.putString(EMAIL_SHARED_PREF, email);
        editor.putString(KEY_PASSWORD,value1);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 1) {
                    toolbar.setBackgroundColor(ContextCompat.getColor(Selection_page2.this,
                            R.color.colorAccent));
                    tabLayout.setBackgroundColor(ContextCompat.getColor(Selection_page2.this,
                            R.color.colorAccent));
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        getWindow().setStatusBarColor(ContextCompat.getColor(Selection_page2.this,
                                R.color.colorAccent));
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent intent = new Intent(Selection_page2.this, Profile.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_report_card) {
            ...
            Intent intent = new Intent(Selection_page2.this, Report_card.class);
            startActivity(intent);
        } else if (id == R.id.nav_E_book) {
            Intent intent = new Intent(Selection_page2.this, Ebook_sub.class);
            startActivity(intent);

        } else if (id == R.id.nav_video) {
            Intent intent = new Intent(Selection_page2.this, Video_url.class);
            startActivity(intent);

        }else if (id == R.id.nav_attendance) {
            Intent intent = new Intent(Selection_page2.this, Attendance.class);
            startActivity(intent);

        } else if (id == R.id.nav_notice) {
            Intent intent = new Intent(Selection_page2.this, Notice.class);
            startActivity(intent);

        }  else if (id == R.id.nav_home_work) {
            Intent intent = new Intent(Selection_page2.this, Home_work.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(Selection_page2.this, About_us.class);
            startActivity(intent);
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(Selection_page2.this, Phone_num.class);
                        startActivity(intent);
                        finish();
                    }
                });
